...
export function Header() {
  return (
    <header className="w-full h-[87px] fixed top-0 bg-zinc-700">
      ...
      <div className="w-full bg-white pt-4 pb-4">
        <div className="w-full mx-0 ">
          <div className="flex w-full pl-8">
            <Image src={ApiPlatform} alt="Icon" />
            <ul>
              <ItemMenuComeco name="Registro" />
            </ul>
            <button className="pl-[1300px]">
              <Image src={inlineButton} alt="Icon" />
            </button>
            <button className="pl-[2px]">
              <Image src={inlineButton2} alt="Icon" />
            </button>
            <div className="pl-[24px] pt-1">
              <Image src={Separator} alt="Icon" />
            </div>
            <div className="pl-[0px]">
              <Image src={Avatar} alt="Avatar" />
            </div>
            <div className="pl-[0px] pt-3">
              <span className="font-bold text-sm align-text-bottom mx-4 mt-2 text-[#9A9A9A]">
                Nome de usuário
              </span>
            </div>
          </div>
